...
const CONFIG = {
  // Business identity
  name: "AntiPest",
  tagline: "Wij bestrijden, u geniet van een pestvrij huis.",
  logoUrl: "/logo.png",
  logoAlt: "AntiPest Logo",
  logoClassName: "h-8 md:h-10", // no invert needed — AntiPest logo is already colored

  // Contact
  phone: "02 378 10 19",
  phoneLink: "tel:+3223781019",
  email: "info@antipest.be",
  whatsapp: "https://api.whatsapp.com/send?phone=3223781019",

  // Location
  address: "Vilvoordestraat 64, 1800 Vilvoorde",
  region: "heel België",
  regionShort: "Vlaanderen & Brussel",
  country: "België",
  ...
  // About text
  aboutText: "AntiPest is al jarenlang dé betrouwbare partner voor het bestrijden en voorkomen van ongedierte voor zowel particulieren als bedrijven in heel België. Ons team heeft een schat aan ervaring opgebouwd in het aanpakken van allerlei soorten ongedierteproblemen. Onze HACCP-gecertificeerde bestrijders staan 7 dagen per week klaar.",

  // Certifications
  certifications: [
    { label: "HACCP Gecertificeerd", icon: "award" },
    { label: "Erkend door FOD", icon: "filecheck" },
    { label: "Eco-verantwoord", icon: "leaf" },
  ],

  // Services with pricing
  services: [
    { title: "Kakkerlakkenbestrijding", desc: "Schakel professionele hulp in om een kakkerlakkenplaag effectief aan te pakken en te voorkomen dat het probleem verergert.", price: "Vanaf €99" },
    { title: "Muizenbestrijding", desc: "Professionele muizenbestrijding is essentieel om schade, ziektes en overlast door muizen effectief en milieuvriendelijk te voorkomen.", price: "Vanaf €79" },
    { title: "Rattenbestrijding", desc: "Schakel een professionele rattenbestrijder in om snel en veilig een rattenplaag aan te pakken en verdere problemen te voorkomen.", price: "Vanaf €89" },
    { title: "Bedwantsenbestrijding", desc: "Bedwantsen verspreiden zich snel en veroorzaken jeukende beten. Professionele bestrijding is nodig om de plaag effectief en duurzaam te verwijderen.", price: "Vanaf €149" },
    { title: "Muggenbestrijding", desc: "Muggen kunnen snel voor overlast zorgen. Met professionele muggenbestrijding wordt de plaag effectief aangepakt zonder risico's.", price: "Vanaf €69" },
    { title: "Wespenbestrijding", desc: "Wespen kunnen agressief reageren en overlast veroorzaken. Wij pakken het probleem veilig en efficiënt aan zonder risico's.", price: "Vanaf €80" },
  ],

  // Testimonials
  testimonials: [
    { name: "Jan V.", location: "Vilvoorde", text: "Heel tevreden over de snelle en professionele aanpak van AntiPest. De muizen zijn volledig weg na één behandeling. Absolute aanrader!" },
    { name: "Eline D.", location: "Brussel", text: "Na maanden last van kakkerlakken heeft AntiPest het probleem in één keer opgelost. Zeer vriendelijk personeel en duidelijke communicatie over de prijs." },
    { name: "Thomas M.", location: "Leuven", text: "Wespennest onder het dak — ze kwamen dezelfde dag nog! Veilig verwijderd en goede preventietips gekregen. Top service!" },
  ],

  // Service regions
  regions: [
    { region: "Vlaams-Brabant", cities: ["Vilvoorde", "Grimbergen", "Zaventem", "Halle", "Dilbeek", "Leuven", "Asse", "Meise", "Tervuren", "Overijse", "Sint-Pieters-Leeuw", "Londerzeel"] },
    { region: "Brussel", cities: ["Jette", "Laeken", "Schaarbeek", "Anderlecht", "Molenbeek", "Ukkel", "Elsene", "Etterbeek", "Evere", "Vorst", "Sint-Gillis", "Woluwe"] },
    { region: "Antwerpen", cities: ["Antwerpen", "Mechelen", "Lier", "Turnhout", "Herentals", "Boom", "Kontich", "Edegem"] },
    { region: "Oost-Vlaanderen", cities: ["Gent", "Aalst", "Sint-Niklaas", "Dendermonde", "Wetteren", "Lokeren"] },
  ],

  // Social links
  social: {
    facebook: "https://www.facebook.com/antipest.be",
    instagram: "#",
    linkedin: "#",
  },
};
